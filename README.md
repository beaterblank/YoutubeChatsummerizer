...
### The Code
Here is the [colab](https://colab.research.google.com/drive/1Mk1WxKF0DaH0sGlfXJHDtNA7zYE8sKTx?usp=sharing) for the algorithm mentioned, or check out [textRank.py](./textRank) implementation for the problem
